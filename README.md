...
This is a hackathon-friendly implementation. Feel free to:
- Add more plant disease classes
- Implement ensemble models
- Add explainability (GradCAM, LIME)
- Create mobile app integration
- Improve severity estimation algorithm

## Support

For issues or questions, refer to the code comments and module docstrings.
